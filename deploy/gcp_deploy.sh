...
gcloud container node-pools create pool-1 --cluster=test-demo --machine-type=n1-standard-1 --num-nodes=1 --service-account='java-dev-kubernetes@appspot.gserviceaccount.com' --node-version=1.10.5-gke.0 --node-labels='type=first' --tags=shuliu
